...
import ma.enset.patient_mvc.security.service.UserDetailsServiceImpl;
...
@Configuration //il sagit dun config
@EnableWebSecurity
public class SecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.formLogin();
        http.authorizeRequests().antMatchers("/").permitAll(); //sans authentification
